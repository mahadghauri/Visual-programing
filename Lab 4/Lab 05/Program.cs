...
public class Program
{
    ...
    {
        var customer = new RetailCustomer(1, "Ghauri", "Mahad", "03 Street", "Multan", "Punjab", "66000", "0300-141214", "ghauri@gmail.com", "pass123", "Visa", "1234-6999-9012-5999");
        var seat = new Seat(2, 5, 15000.0m, "Available");
        var flight = new Flight("MLM3211", "Islamabad", "Lahore", DateTime.Today.AddHours(2), DateTime.Today.AddHours(4));
        var reservation = new Reservation("RSR32", DateTime.Today, flight, seat);
